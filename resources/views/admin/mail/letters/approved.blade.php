...
@section('title', 'Approved Letters')
@section('page_title', 'Approved Letters')
@section('page_subtitle', 'All approved child letters visible to receivers')
                        ...
                        @forelse($letters as $letter)
                            <tr class="transition hover:bg-neutral-50/70">
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex items-center gap-3">
                                        @if($letter->sender?->profile?->avatar_type === 'upload' && $letter->sender?->profile?->avatar)
                                            <img src="{{ asset('storage/' . $letter->sender->profile->avatar) }}"
                                ...
                                <td class="px-6 py-5 text-sm text-neutral-500">
                                    {{ $letter->approved_at?->format('d M Y, h:i A') ?? 'N/A' }}
                                </td>
