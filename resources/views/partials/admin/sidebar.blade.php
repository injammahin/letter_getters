<aside class="fixed inset-y-0 left-0 z-50 flex flex-col border-r border-black/5 bg-white transition-all duration-300"
    :class="[
        desktopCollapsed ? 'w-24' : 'w-72',
        mobileSidebar ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
    ]">
    <div class="flex h-20 items-center justify-between border-b border-black/5 px-4"
        :class="desktopCollapsed ? 'lg:px-3' : 'lg:px-5'">
    ...
    <div class="flex-1 overflow-y-auto px-3 py-4">
        <nav class="space-y-2">
            <a href="{{ url('/admin/dashboard') }}" @click="mobileSidebar = false"
            ...
            <div x-data="{ open: {{ request()->is('admin/users*') || request()->is('admin/parents-children*') ? 'true' : 'false' }} }"
                class="rounded-2xl">
                ...
                <div x-show="open && !desktopCollapsed" x-cloak class="mt-2 space-y-2 pl-11 pr-3">
                    <a href="{{ url('/admin/users') }}"
                        class="admin-submenu-link block text-sm {{ request()->is('admin/users') ? 'admin-submenu-link-active' : 'text-black/60' }}">All
                        Users</a>
                    <a href="{{ url('/admin/users/children') }}"
                        class="admin-submenu-link block text-sm {{ request()->is('admin/users/children*') ? 'admin-submenu-link-active' : 'text-black/60' }}">Child
                        Users</a>
                    <a href="{{ url('/admin/users/parents') }}"
                        class="admin-submenu-link block text-sm {{ request()->is('admin/users/parents*') ? 'admin-submenu-link-active' : 'text-black/60' }}">Parent
                        Users</a>
                    <a href="{{ url('/admin/users/adults') }}"
                        class="admin-submenu-link block text-sm {{ request()->is('admin/users/adults*') ? 'admin-submenu-link-active' : 'text-black/60' }}">Adult
                        Users</a>
                    <a href="{{ url('/admin/users/staff') }}"
                        class="admin-submenu-link block text-sm {{ request()->is('admin/users/staff*') ? 'admin-submenu-link-active' : 'text-black/60' }}">Staff
                        & Moderators</a>
                    <a href="{{ url('/admin/parents-children') }}"
                        class="admin-submenu-link block text-sm {{ request()->is('admin/parents-children*') ? 'admin-submenu-link-active' : 'text-black/60' }}">Parent-Child
                        Links</a>
                </div>
            </div>
            ...
            <div x-data="{ open: {{ request()->is('admin/matches*') ? 'true' : 'false' }} }" class="rounded-2xl">
                ...
                <div x-show="open && !desktopCollapsed" x-cloak class="mt-2 space-y-2 pl-11 pr-3">
                    <a href="{{ url('/admin/matches/suggested') }}"
                        class="admin-submenu-link block text-sm text-black/60">Suggested Matches</a>
                    <a href="{{ route('admin.matches.pending') }}"
                        class="admin-submenu-link block text-sm {{ request()->routeIs('admin.matches.pending') ? 'admin-submenu-link-active' : 'text-black/60' }}">
                        Pending Approvals
                    </a>

                    <a href="{{ route('admin.matches.approved') }}"
                        class="admin-submenu-link block text-sm {{ request()->routeIs('admin.matches.approved') ? 'admin-submenu-link-active' : 'text-black/60' }}">
                        Approved Matches
                    </a>
                    <a href="{{ url('/admin/matches/blocked') }}"
                        class="admin-submenu-link block text-sm text-black/60">Blocked / Removed</a>
                    <a href="{{ url('/admin/matches/history') }}"
                        class="admin-submenu-link block text-sm text-black/60">Match History</a>
                </div>
            </div>
            ...
            <a href="{{ route('admin.support-tickets.index') }}" @click="mobileSidebar = false"
            ...
            <div x-data="{ open: {{ request()->is('admin/mail*') ? 'true' : 'false' }} }" class="rounded-2xl">
                ...
                <div x-show="open && !desktopCollapsed" x-cloak class="mt-2 space-y-2 pl-11 pr-3">
                    <a href="{{ route('admin.child-letters.pending') }}"
                        class="admin-submenu-link block text-sm {{ request()->routeIs('admin.child-letters.*') ? 'admin-submenu-link-active' : 'text-black/60' }}">
                        Letter Review
                    </a>
                    <a href="{{ route('admin.child-letters.approved') }}"
                        class="admin-submenu-link block text-sm {{ request()->routeIs('admin.child-letters.approved') ? 'admin-submenu-link-active' : 'text-black/60' }}">
                        Approved Letters
                    </a>
                    <a href="{{ route('admin.child-letters.rejected') }}"
                        class="admin-submenu-link block text-sm {{ request()->routeIs('admin.child-letters.rejected') ? 'admin-submenu-link-active' : 'text-black/60' }}">
                        Rejected Letters
                    </a>
                    <a href="{{ url('/admin/mail/preview-queue') }}"
                        class="admin-submenu-link block text-sm text-black/60">Preview Queue</a>
                    <a href="{{ url('/admin/mail/status-tracking') }}"
                        class="admin-submenu-link block text-sm text-black/60">Status Tracking</a>
                    <a href="{{ url('/admin/mail/archive') }}"
                        class="admin-submenu-link block text-sm text-black/60">Letter Archive</a>
                    <a href="{{ url('/admin/mail/fulfillment') }}"
                        class="admin-submenu-link block text-sm text-black/60">Forwarding & Fulfillment</a>
                </div>
            </div>
            ...
            <div x-data="{ open: {{ request()->is('admin/moderation*') ? 'true' : 'false' }} }" class="rounded-2xl">
                ...
                <div x-show="open && !desktopCollapsed" x-cloak class="mt-2 space-y-2 pl-11 pr-3">
                    <a href="{{ url('/admin/moderation/reports') }}"
                        class="admin-submenu-link block text-sm text-black/60">Reports</a>
                    <a href="{{ url('/admin/moderation/flagged-content') }}"
                        class="admin-submenu-link block text-sm text-black/60">Flagged Content</a>
                    <a href="{{ url('/admin/moderation/suspended-accounts') }}"
                        class="admin-submenu-link block text-sm text-black/60">Suspended Accounts</a>
                    <a href="{{ url('/admin/moderation/logs') }}"
                        class="admin-submenu-link block text-sm text-black/60">Moderation Logs</a>
                </div>
            </div>
            ...
            <div x-data="{ open: {{ request()->is('admin/rewards*') ? 'true' : 'false' }} }" class="rounded-2xl">
                ...
                <div x-show="open && !desktopCollapsed" x-cloak class="mt-2 space-y-2 pl-11 pr-3">
                    <a href="{{ url('/admin/rewards/coins') }}"
                        class="admin-submenu-link block text-sm text-black/60">Coin Rules</a>
                    <a href="{{ url('/admin/rewards/avatar-items') }}"
                        class="admin-submenu-link block text-sm text-black/60">Avatar Items</a>
                    <a href="{{ url('/admin/rewards/printables') }}"
                        class="admin-submenu-link block text-sm text-black/60">Printable Stationery</a>
                    <a href="{{ url('/admin/rewards/unlocks') }}"
                        class="admin-submenu-link block text-sm text-black/60">Reward Unlocks</a>
                </div>
            </div>
            ...
            <div x-data="{ open: {{ request()->is('admin/store*') ? 'true' : 'false' }} }" class="rounded-2xl">
                ...
                <div x-show="open && !desktopCollapsed" x-cloak class="mt-2 space-y-2 pl-11 pr-3">
                    <a href="{{ route('admin.store.categories.index') }}"
                        class="admin-submenu-link block text-sm {{ request()->routeIs('admin.store.categories.*') ? 'admin-submenu-link-active' : 'text-black/60' }}">Categories</a>
                    <a href="{{ route('admin.store.products.index') }}"
                        class="admin-submenu-link block text-sm {{ request()->routeIs('admin.store.products.*') ? 'admin-submenu-link-active' : 'text-black/60' }}">Products</a>
                    <a href="{{ route('admin.store.orders.index') }}"
                        class="admin-submenu-link block text-sm {{ request()->routeIs('admin.store.orders.*') ? 'admin-submenu-link-active' : 'text-black/60' }}">Orders</a>
                    <a href="{{ route('admin.store.shipping.index') }}"
                        class="admin-submenu-link block text-sm {{ request()->routeIs('admin.store.shipping.*') ? 'admin-submenu-link-active' : 'text-black/60' }}">Shipping</a>
                    <a href="{{ route('admin.store.inventory.index') }}"
                        class="admin-submenu-link block text-sm {{ request()->routeIs('admin.store.inventory.*') ? 'admin-submenu-link-active' : 'text-black/60' }}">Inventory</a>
                </div>
            </div>
            ...
            <div x-data="{ open: {{ request()->is('admin/content*') ? 'true' : 'false' }} }" class="rounded-2xl">
                ...
                <div x-show="open && !desktopCollapsed" x-cloak class="mt-2 space-y-2 pl-11 pr-3">
                    <a href="{{ url('/admin/content/homepage') }}"
                        class="admin-submenu-link block text-sm text-black/60">Homepage Content</a>
                    <a href="{{ url('/admin/content/safety-page') }}"
                        class="admin-submenu-link block text-sm text-black/60">Safety Page</a>
                    <a href="{{ url('/admin/content/writing-tips') }}"
                        class="admin-submenu-link block text-sm text-black/60">Writing Tips</a>
                    <a href="{{ url('/admin/content/faq') }}" class="admin-submenu-link block text-sm text-black/60">FAQ
                        / Help</a>
                </div>
            </div>
            ...
            <div x-data="{ open: {{ request()->is('admin/reports*') ? 'true' : 'false' }} }" class="rounded-2xl">
                ...
                <div x-show="open && !desktopCollapsed" x-cloak class="mt-2 space-y-2 pl-11 pr-3">
                    <a href="{{ url('/admin/reports/users') }}"
                        class="admin-submenu-link block text-sm text-black/60">User Reports</a>
                    <a href="{{ url('/admin/reports/letters') }}"
                        class="admin-submenu-link block text-sm text-black/60">Letter Reports</a>
                    <a href="{{ url('/admin/reports/revenue') }}"
                        class="admin-submenu-link block text-sm text-black/60">Revenue Reports</a>
                    <a href="{{ url('/admin/reports/rewards') }}"
                        class="admin-submenu-link block text-sm text-black/60">Rewards Reports</a>
                </div>
            </div>
            ...
            <div x-data="{ open: {{ request()->is('admin/settings*') ? 'true' : 'false' }} }" class="rounded-2xl">
                ...
                <div x-show="open && !desktopCollapsed" x-cloak class="mt-2 space-y-2 pl-11 pr-3">
                    <a href="{{ url('/admin/settings/general') }}"
                        class="admin-submenu-link block text-sm text-black/60">General Settings</a>
                    <a href="{{ url('/admin/settings/roles-permissions') }}"
                        class="admin-submenu-link block text-sm text-black/60">Roles & Permissions</a>
                    <a href="{{ url('/admin/settings/notifications') }}"
                        class="admin-submenu-link block text-sm text-black/60">Notification Settings</a>
                    <a href="{{ url('/admin/settings/security') }}"
                        class="admin-submenu-link block text-sm text-black/60">Security Settings</a>
                </div>
            </div>
        </nav>
    </div>
